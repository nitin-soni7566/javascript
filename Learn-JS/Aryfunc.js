    ...
    // let y = x.toString();
    // // this function converts arrays into a string
    // console.log(x, y);
    ...
    // let y2 = x.pop()
    // console.log(x, y2); // return the poped element  

    // let y3 = x.push(20); // push returns the new array length
    // console.log(x, y3);

    // let y4 = x.shift(); // remove 1st element and return it
    // console.log(x, y4);

    // let y5 = x.unshift(1); // add 1st element and return it
    //console.log(y5, x);
